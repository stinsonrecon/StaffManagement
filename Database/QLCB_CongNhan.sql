...
CREATE TABLE `CongNhan` (
  `IdPREFIX` varchar(20) NOT NULL DEFAULT 'CN',
  `IdCanBo` int NOT NULL,
  `CapBac` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`IdPREFIX`,`IdCanBo`),
  KEY `IdCanBo` (`IdCanBo`),
  CONSTRAINT `congnhan_ibfk_1` FOREIGN KEY (`IdCanBo`) REFERENCES `CanBo` (`IdCanBo`)
...
INSERT INTO `CongNhan` VALUES ('CN',1,'Senior'),('CN',2,'Fresher'),('CN',4,'Senior'),('CN',28,'Director'),('CN',31,'fresher');
